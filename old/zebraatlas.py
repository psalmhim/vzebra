...
from PySide6.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QCheckBox, QSlider, QLabel, QHBoxLayout,QGroupBox,QPushButton
...
class vtkZebraWidget(QWidget):
    ...
    def render(self):
        ...
        self.renderer.SetBackground(1,1,1) #0.1, 0.2, 0.3)  # Set background color to white
