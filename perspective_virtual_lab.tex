...
\author{%
  Hae-Jeong Park$^{1,2,3,4,5}$%
  \thanks{Correspondence: \texttt{parkhj@yuhs.ac}}%
  \\[6pt]
  \small$^{1}$Division of Pediatric Neurology, Department of Pediatrics,
  Severance Children's Hospital, Yonsei University College of Medicine\\
  \small$^{2}$Neuroscience Research Institute, Epilepsy Research Institute,
  Yonsei University College of Medicine\\
  \small$^{3}$Graduate School of Medical Science, Brain Korea 21 Project,
  Yonsei University College of Medicine\\
  \small$^{4}$Center for Systems and Translational Brain Sciences,
  Institute of Human Complexity and Systems Science, Yonsei University\\
  \small$^{5}$Department of Cognitive Science, Yonsei University, Seoul, Republic of Korea%
}
...
H.J.P.: Conceptualization, Methodology, Software, Formal analysis,
