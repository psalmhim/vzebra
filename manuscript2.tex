...
\end{equation}
aggregating 148 two-compartment neurons across all sensory, thalamic,
...
\midrule
\textbf{Total} & \textbf{33} & & \textbf{148} \\
\bottomrule
\end{tabular}
\end{table}
...
All 39 brain modules are covered by a systematic test suite comprising
eight test levels (182 spiking-brain assertions, all passing),
...
The developmental curriculum approach could be applied to other model
organisms: \textit{Drosophila} ($\sim$100,000 neurons, complete
connectome), mouse ($\sim$70M neurons, partial connectome), or human
cortical organoids---testing whether the same active inference
architecture scales across brain sizes and complexity levels, and
whether disorder phenotypes exhibit homologous behavioral signatures
across species.
