...
The architecture comprises 29~brain modules totalling 7,166 Izhikevich
spiking neurons with conductance-based synapses (AMPA, NMDA, GABA$_A$),
organized into 22~spiking and 7~rate/analytic subsystems.
...
The system achieves 69/100 on a five-scenario decision rationality
benchmark, survives $474 \pm 72$ steps across 9~seeds
($6.0 \pm 2.4$ food eaten), and outperforms the predecessor v1 model
by 32\% in survival and 156\% in food intake.
A retrained spiking classifier achieves 96.2\% accuracy and a
three-stage curriculum passes all stages.
...
zebrafish brain comprising 29~modules and 7,166 Izhikevich neurons
...
Key results include 69/100 decision rationality across five
cognitive scenarios, 32\% improvement in survival and 156\%
improvement in foraging over v1, a 96.2\% spiking classifier, and
a three-stage curriculum that passes all stages.
...
\midrule
\textbf{Total}            &           &             & \textbf{7\,166 SNN + 2\,930 rate} & \textbf{29 modules} \\
\bottomrule
\end{tabular}
\end{table}
...
Metric & v1 & v2 \\
\midrule
SNN neurons              & 3\,470 (rate-coded) & 7\,166 (Izhikevich) \\
...
Modules                  & 42 steps            & 29 modules \\
Classifier accuracy      & 90.6\%              & 96.2\% \\
Mean survival (3 seeds)  & 319 steps           & 422 steps (+32\%) \\
Mean food (3 seeds)      & 3.0                 & 7.7 (+156\%) \\
Multi-seed survival      & --                  & $474 \pm 72$ (9 seeds) \\
Multi-seed food          & --                  & $6.0 \pm 2.4$ \\
Decision rationality     & 84/100              & 69/100 \\
