...
(Figure~\ref{fig:scenarios}).  The system achieves 84/100 overall,
with all scenarios at grade~B or above.
...
\caption{Decision rationality scores across 5 structured scenarios.
  A=92 (safe vs.\ risky food), B=100 (occluded food), C=85 (predator charge),
  D=70 (starvation dilemma), E=74 (detour).  Overall: 84/100 \textsc{rational}.}
\label{fig:scenarios}
\end{figure}
