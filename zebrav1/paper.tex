...
Scenario~E from 34 to 81.  The Scenario~E improvement comes from a
forage-no-progress detector: after 30 steps of FORAGE with no food
eaten and no predator visible, the fish switches to EXPLORE for 20
steps, generating wider search arcs that naturally route around
obstacles.
