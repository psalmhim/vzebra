...
Run: python -m zebrav1.tests.step10_hebbian_finetuning
Output: plots/v1_step10_hebbian_finetuning.png
"""
import os
import sys
import math
...
def run_step10():
    ...
    device = get_device()
    weights_path = os.path.join(PROJECT_ROOT, "zebrav1", "weights", "genomic.pt")
    ...
    model_a = ZebrafishSNN(device=device)
    ...
    model_b = ZebrafishSNN(device=device)
    ...
    model_c = ZebrafishSNN(device=device)
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step10_hebbian_finetuning.png")
    ...
    hebb_path = os.path.join(weights_dir, "genomic_hebbian.pt")
