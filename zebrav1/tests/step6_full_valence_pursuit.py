...
Run: python -m zebrav1.tests.step6_full_valence_pursuit
Output: plots/v1_step6_full_valence_pursuit.png
"""
import os
import sys
import math
...
from zebrav1.tests.step1_vision_pursuit import make_object_trajectory, compute_retinal_turn
...
def run_step6(T=300, amplitude=60.0):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step6_full_valence_pursuit.png")
