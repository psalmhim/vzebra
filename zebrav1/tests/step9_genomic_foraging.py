...
Run: python -m zebrav1.tests.step9_genomic_foraging
Output: plots/v1_step9_genomic_foraging.png
"""
import os
import sys
import math
...
def run_step9():
    ...
    model_random = ZebrafishSNN(device=device)
    ...
    model_genomic = ZebrafishSNN(device=device)
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step9_genomic_foraging.png")
