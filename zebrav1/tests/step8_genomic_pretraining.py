...
Run: python -m zebrav1.tests.step8_genomic_pretraining
Output: plots/v1_step8_genomic_pretraining.png
        zebrav1/weights/genomic.pt
"""
import os
import sys
import math
...
def run_step8(n_epochs=120, samples_per_epoch=50, n_integration=5, lr=0.005):
    ...
    weights_path = os.path.join(weights_dir, "genomic.pt")
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step8_genomic_pretraining.png")
