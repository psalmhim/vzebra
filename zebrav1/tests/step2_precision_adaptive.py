...
Run: python -m zebrav1.tests.step2_precision_adaptive
Output: plots/v1_step2_precision_adaptive.png
"""
import os
import sys
import math
...
def run_step2(T=250, k_eye=1.5, amplitude=60.0):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step2_precision_adaptive.png")
