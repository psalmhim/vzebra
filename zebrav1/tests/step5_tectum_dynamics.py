...
Run: python -m zebrav1.tests.step5_tectum_dynamics
Output: plots/v1_step5_tectum_dynamics.png
"""
import os
import sys
import math
...
def run_step5(T=300, amplitude=60.0):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step5_tectum_dynamics.png")
