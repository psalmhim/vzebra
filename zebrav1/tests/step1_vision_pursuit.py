...
Make v1 SNN track a moving object with eye movements.
...
Run: python -m zebrav1.tests.step1_vision_pursuit
Output: plots/v1_step1_vision_pursuit.png
"""
import os
import sys
import math
...
def run_step1(T=200, k_eye=1.5, amplitude=60.0):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step1_vision_pursuit.png")
