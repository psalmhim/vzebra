...
Run: python -m zebrav1.tests.step12_classification_guided_behavior
Output: plots/v1_step12_classification_guided_behavior.png
"""
import os
import sys
import math
...
def run_step12(T=800, swim_speed=1.5, base_turn_gain=0.15):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots",
                              "v1_step12_classification_guided_behavior.png")
