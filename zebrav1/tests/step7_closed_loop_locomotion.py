...
Run: python -m zebrav1.tests.step7_closed_loop_locomotion
Output: plots/v1_step7_closed_loop_locomotion.png
"""
import os
import sys
import math
...
def run_step7(T=500, swim_speed=1.5, turn_gain=0.15):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v1_step7_closed_loop_locomotion.png")
