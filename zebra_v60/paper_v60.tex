...
\title{%
  ...
  \large Technical Report --- Zebrafish SNN v60 (Steps 1--26)
}
...
The model is developed in twenty-six progressive steps, each adding a
...
food (6--14 items per 800-step episode), avoids predators, navigates around
...
The model is built incrementally across twenty-six developmental steps, each
...
The twenty-six-step developmental curriculum demonstrates that a biologically
