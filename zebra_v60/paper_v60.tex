...
\midrule
Baseline    & 800 & 6  & 76.8 & 0  \\
Full Brain  & 800 & 10 & 73.3 & 28 \\
Place Cell  & 800 & 9  & 90.7 & 23 \\
\bottomrule
\end{tabular}
\end{table}

With the full pipeline---amygdala fear circuit, Bayesian survival trade-off,
enhanced classifier, and online feedback training (Steps~20--26)---all three
configurations survive the full 800 steps and forage successfully.
The Full Brain configuration achieves 10 food items with 28 memory nodes.
The Place Cell configuration achieves 9 food items with the highest final
energy (90.7), demonstrating that spatial memory combined with softened
starvation mechanics enables efficient food-patch return.
The Baseline configuration eats 6 food items even without world models or
allostasis, indicating that the improved classifier and survival trade-off
benefit all configurations.
