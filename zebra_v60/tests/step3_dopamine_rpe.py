...
Run: python -m zebra_v60.tests.step3_dopamine_rpe
Output: plots/v60_step3_dopamine_rpe.png
"""
import os
import sys
import math
...
def run_step3(T=250, k_eye=1.5, amplitude=60.0):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v60_step3_dopamine_rpe.png")
