...
Run: python -m zebra_v60.tests.step12b_detect_respond_demo
Output: plots/v60_step12b_detect_respond_demo.png
"""
import os
import sys
import math
...
# Type encoding values (must match retina_sampling_v60.py)
TYPE_FOOD = 1.0
TYPE_ENEMY = 0.5
...
def compute_valence_turn(out):
    ...
    # Food pixels: type ≈ 1.0 (threshold > 0.75 to avoid enemy/colleague)
...
def run_step12b():
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots",
                              "v60_step12b_detect_respond_demo.png")
