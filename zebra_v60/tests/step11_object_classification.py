...
Run: python -m zebra_v60.tests.step11_object_classification
Output: plots/v60_step11_object_classification.png
        zebra_v60/weights/classifier_v60.pt
"""
import os
import sys
import math
...
def run_step11(n_epochs=250, samples_per_epoch=150, lr=0.01, n_integration=3):
    ...
    weights_path = os.path.join(weights_dir, "classifier_v60.pt")
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v60_step11_object_classification.png")
