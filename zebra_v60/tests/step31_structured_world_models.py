...
Run: python -m zebra_v60.tests.step31_structured_world_models
"""
import os
import sys
import math
...
def run_step31():
    ...
    plt.savefig("plots/v60_step31_structured_world_models.png", dpi=150)
    print(f"\nPlot saved: plots/v60_step31_structured_world_models.png")
