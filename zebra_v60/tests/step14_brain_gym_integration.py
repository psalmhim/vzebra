...
Run: python -m zebra_v60.tests.step14_brain_gym_integration
Output: plots/v60_step14_brain_gym_integration.png
"""
import os
import sys
import math
...
from zebra_v60.brain.goal_policy_v60 import GOAL_NAMES, GOAL_FORAGE, GOAL_FLEE, GOAL_EXPLORE
...
def run_step14(T=600):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots",
                              "v60_step14_brain_gym_integration.png")
