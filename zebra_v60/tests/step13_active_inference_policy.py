...
New modules:
  - GoalPolicy_v60:    EFE computation, softmax posterior, persistence timer
  - WorkingMemory_v60: Goal-conditioned memory trace with dopamine modulation

Run: python -m zebra_v60.tests.step13_active_inference_policy
Output: plots/v60_step13_active_inference_policy.png
"""
import os
import sys
import math
...
def run_step13(T=1000, swim_speed=1.5, base_turn_gain=0.15):
    ...
    goal_policy = GoalPolicy_v60(n_goals=3, beta=2.0, persist_steps=8)
    wm = WorkingMemory_v60(n_latent=16, n_goals=3, buffer_len=20)
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots",
                              "v60_step13_active_inference_policy.png")
