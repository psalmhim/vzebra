...
from zebra_v60.brain.goal_policy_v60 import SpikingGoalSelector
from zebra_v60.brain.working_memory_v60 import SpikingWorkingMemory
...
class PredatorBrainAgent:
    ...
    def __init__(self, device="auto"):
        ...
        # Brain modules
        self.dopa_sys = DopamineSystem_v60(alpha=0.08, beta=2.5, decay=0.97)
