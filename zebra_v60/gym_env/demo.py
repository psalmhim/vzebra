...
Run:
  python -m zebra_v60.gym_env.demo             # random, headless
  python -m zebra_v60.gym_env.demo --heuristic  # heuristic, headless
  python -m zebra_v60.gym_env.demo --render      # heuristic, pygame window
  python -m zebra_v60.gym_env.demo --brain --monitor  # brain agent + neural viz
  python -m zebra_v60.gym_env.demo --brain --render --record  # save MP4 video
  python -m zebra_v60.gym_env.demo --brain --monitor --record --steps 800

Output: plots/v60_gym_env_demo.png, plots/zebrafish_brain_demo.mp4
"""
import os
import sys
import math
...
def run_demo(use_heuristic=False, render=False, T=1000):
    ...
    save_path = os.path.join(PROJECT_ROOT, "plots", "v60_gym_env_demo.png")
...
def run_brain_demo(render=False, monitor=False, record=False, T=1000,
    ...
    # Save checkpoint
    if autosave:
        ckpt_dir = os.path.join(PROJECT_ROOT, "zebra_v60", "weights")
